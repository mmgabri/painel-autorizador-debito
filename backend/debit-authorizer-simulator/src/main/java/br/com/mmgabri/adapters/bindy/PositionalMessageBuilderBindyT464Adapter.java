...
public class PositionalMessageBuilderBindyT464Adapter implements PositionalMessageBuilderAdapter {
    ...
    public PositionalMessageBuilderBindyT464Adapter() {
        try {
            ...
            throw new ApplicationException("BINDY_INIT_ERROR", "Falha ao inicializar o contexto Camel para o builder T464.");
        }
    }
    ...
    public String build(Map<String, String> fields, String mti) {
        try {
            ...
            throw new ApplicationException("BINDY_BUILD_ERROR", "Falha ao montar a mensagem posicional T464.");
        }
    }
