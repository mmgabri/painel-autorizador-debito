...
@Component
public class PositionalMessageParserBindyTcrAdapter implements PositionalMessageParserAdapter {
    ...
    public PositionalMessageParserBindyTcrAdapter() {
        try {
            this.camelContext.start();
        } catch (Exception e) {
            throw new ApplicationException("BINDY_INIT_ERROR", "Falha ao inicializar o contexto Camel para o parser TCR.");
        }
    }
    ...
    public Map<String, String> parse(String positionalMessage) {
        try {
            ...
            throw new ApplicationException("BINDY_PARSE_ERROR", "Falha ao fazer o parse da mensagem posicional TCR.");
        }
    }
